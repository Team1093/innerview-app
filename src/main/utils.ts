...
export async function processVideoFile({
  ...
  const videoPreprocessFilters = [
    ...
    },
    {
      filter: 'concat',
      options: 'n=2:v=1:a=0',
      inputs: ['first_pts', 'second_pts'],
      outputs: 'concatenatedVideo'
    },
    {
      filter: 'format',
      options: 'yuv420p', // 색상 포맷 설정
      inputs: 'concatenatedVideo',
      outputs: 'processedVideo'
    }
  ]

  const audioPreprocessFilters = [
    {
      filter: 'atrim',
      options: '0:15',
      inputs: '0:a',
    ...
    },
    {
      ...
      options: 'PTS-STARTPTS',
      inputs: 'first_audio',
      outputs: 'first_audio_pts'
    },
    {
      filter: 'atrim',
      options: '24:',
      inputs: '0:a',
      outputs: 'second_audio'
    },
    {
      filter: 'asetpts',
      options: 'PTS-STARTPTS',
      inputs: 'second_audio',
      outputs: 'second_audio_pts'
    },
    {
      filter: 'concat',
      options: 'n=2:v=0:a=1',
      inputs: ['first_audio_pts', 'second_audio_pts'],
      outputs: 'concatenatedAudio'
    },
    {
      filter: 'aresample',
      options:
        location === 'innerview'
          ? 'async=1:min_hard_comp=0.200:first_pts=0'
          : 'async=1:min_hard_comp=0.001:first_pts=0',
      inputs: 'concatenatedAudio',
  ...
  const finalFilter = [
    ...videoPreprocessFilters,
    ...audioPreprocessFilters,
    ...commonFilters[0],
