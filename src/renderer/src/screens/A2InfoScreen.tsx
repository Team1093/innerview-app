...
import ko_couple from '../assets/videos/start_guide.mp4'
import en_single from '../assets/videos/start_guide.mp4'
import en_couple from '../assets/videos/start_guide.mp4'
